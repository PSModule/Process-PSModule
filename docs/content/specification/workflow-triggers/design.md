...
The caller-level group covers all nested reusable jobs until the calling job completes. It therefore serializes planning,
version resolution, publication, and enabled teardown rather than only a short admission step.
